...
echo form_open('pricesheets/create')."\n";
...
echo form_fieldset('Features');
	echo '<div class="Features">';
		echo form_label('Features', 'Features') . '<br>';
		echo form_label('Included', 'That') . '<br>';
		echo form_label('In', 'Match') . '<br>';
		echo form_label('The', 'The') . '<br>';
		echo form_label('Vehicle', 'Vehicle') . '<br>';
		echo form_label('Package', 'Model Code') . '<br>';
	echo '</div>';
echo form_fieldset_close();
